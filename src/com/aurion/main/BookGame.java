...
public class BookGame {
	...
	public static void playGame() {
		...
		System.out.println("Player 1 is out Now Player 2 turn is started....");
		System.out.println("-----x-----x-----x-----x-----x-----x-----x-----x-----x");
		while (true) {
		...
		System.out.println("Total Score of Player 1 is : " + player1Score + " in " + player1Turns + " turns");
		System.out.println("Total Score of Player 2 is : " + player2Score + " in " + player2Turns + " turns");
